...
def afk(bot: Bot, update: Update):
    ...
    send_message(update.effective_message, tl(update.effective_message, "{} sudah Offline, Silahkan Menunggunya Kembali !").format(update.effective_user.first_name))
...
def no_longer_afk(bot: Bot, update: Update):
    ...
    if res:
        send_message(update.effective_message, tl(update.effective_message, "{} sudah Kembali, Sapa Dia !").format(update.effective_user.first_name))
